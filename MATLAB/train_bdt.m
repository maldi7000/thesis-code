function [ bdt ] = train_bdt(X,T,N, varargin)
%TRAIN_BDT trains a boosted decision tree
%
% BDT = TRAIN_BDT(X,T,N,Name,Value) trains a boosted decision tree
% (fitensemble) on the input data X and the target classes T. 
% N is the number of boosts (trees) that are used in the training. The
